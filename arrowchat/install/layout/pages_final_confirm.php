			<form method="post" id="final_form" action="<?php echo $_SERVER['PHP_SELF']; ?>?mode=final">
					<p class="subtext">This final step will write all your information to the files and database. Please confirm that everything is correct before continuing. You can change these details be clicking the corresponding tab at the top.</p><p>&nbsp;</p>
				<div class="final-step">
					<ul class="clearfix">
						<li><b>Installation type</b></li>
						<li class="col2"><img src="./images/img-<?php $realid = explode("_", $_SESSION['version']); echo $realid[0]; ?>.png" alt="" /></li>
					</ul>
					<ul class="clearfix">
