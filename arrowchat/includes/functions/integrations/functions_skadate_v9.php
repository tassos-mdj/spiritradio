<?php
	...
	*/
	...
	function get_friend_list($userid, $time) 
	{
		...
		$sql = ("
			SELECT DISTINCT " . TABLE_PREFIX . DB_USERTABLE . "." . DB_USERTABLE_USERID . " userid, " . TABLE_PREFIX . DB_USERTABLE . "." . DB_USERTABLE_NAME . " username, arrowchat_status.session_time lastactivity, (SELECT concat(profile_id,'_',photo_id,'_'," . TABLE_PREFIX . "profile_photo.index) from " . TABLE_PREFIX . "profile_photo where profile_id = " . TABLE_PREFIX . DB_USERTABLE . "." . DB_USERTABLE_USERID . " and status = 'active' limit 1) avatar, " . TABLE_PREFIX . DB_USERTABLE . "." . DB_USERTABLE_NAME . " link, arrowchat_status.is_admin, arrowchat_status.status 
	...
	function get_user_details($userid) 
	{
		...
		$sql = ("
			SELECT " . TABLE_PREFIX . DB_USERTABLE . "." . DB_USERTABLE_USERID . " userid, " . TABLE_PREFIX . DB_USERTABLE . "." . DB_USERTABLE_NAME . " username, arrowchat_status.session_time lastactivity,  " . TABLE_PREFIX . DB_USERTABLE . "." . DB_USERTABLE_NAME . " link,  (SELECT concat(profile_id,'_',photo_id,'_'," . TABLE_PREFIX . "profile_photo.index) from " . TABLE_PREFIX . "profile_photo where profile_id = " . TABLE_PREFIX . DB_USERTABLE . "." . DB_USERTABLE_USERID . " and status = 'active' limit 1) avatar, arrowchat_status.is_admin, arrowchat_status.status 
			FROM " . TABLE_PREFIX . DB_USERTABLE . " 
			LEFT JOIN arrowchat_status 
				ON " . TABLE_PREFIX . DB_USERTABLE . "." . DB_USERTABLE_USERID . " = arrowchat_status.userid 
	...
	function get_link($link, $user_id) 
	{
		...
		return $base_url . '../member/profile_' . $link . '.html';
	}
