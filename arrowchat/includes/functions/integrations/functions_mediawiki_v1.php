<?php
	...
	*/
	...
	function get_user_id() 
	{
		...
		if (isset($_COOKIE['mediawikiUserID']))
		{
			$userid = $_COOKIE['mediawikiUserID'];
		} 
		else if (isset($_COOKIE[DB_NAME . '_mediawiki_UserID']))
		{
			$userid = $_COOKIE[DB_NAME . '_mediawiki_UserID'];
		}
		else if (isset($_COOKIE[DB_NAME . '_' . TABLE_PREFIX . 'UserID']))
		{
			$userid = $_COOKIE[DB_NAME . '_' . TABLE_PREFIX . 'UserID'];
		}
		else if (isset($_COOKIE[DB_NAME . 'UserID']))
		{
			$userid = $_COOKIE[DB_NAME . 'UserID'];
		}
	...
	function get_group_id($userid)
	{
		...
		$result = $db->execute("
			...
			WHERE ug_user = '" . $db->escape_string($userid) . "'
		");
	...
	function get_all_groups()
	{
		...
		$groups[] = array("bot", "Bots");
		$groups[] = array("bureaucrat", "Bureaucrats");
		$groups[] = array("sysop", "Administrators");
