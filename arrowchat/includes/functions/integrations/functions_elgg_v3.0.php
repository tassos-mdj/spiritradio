<?php
	...
	*/
	...
	function get_friend_list($userid, $time) 
	{
		...
		$sql = ("
			SELECT DISTINCT " . TABLE_PREFIX . DB_USERTABLE . "." . DB_USERTABLE_USERID . " userid, " . TABLE_PREFIX . "metadata." . DB_USERTABLE_NAME . " username, arrowchat_status.session_time lastactivity, " . TABLE_PREFIX . DB_USERTABLE . "." . DB_USERTABLE_AVATAR . " avatar, " . TABLE_PREFIX . "metadata." . DB_USERTABLE_NAME . " link, arrowchat_status.is_admin, arrowchat_status.status 
			...
			LEFT JOIN " . TABLE_PREFIX . "metadata
				ON (" . TABLE_PREFIX . "metadata.entity_guid = " . TABLE_PREFIX . DB_USERTABLE . "." . DB_USERTABLE_USERID . " 
					AND " . TABLE_PREFIX . "metadata.name = 'username')
			...
			ORDER BY " . TABLE_PREFIX . "metadata." . DB_USERTABLE_NAME . " ASC
		");
	...
	{ 
		...
		$result = $db->execute("
			...
			FROM " . TABLE_PREFIX . "metadata
			WHERE entity_guid = '" . $db->escape_string($userid) . "'
				AND name = 'username'
		");  
