...
?>
					...
					<fieldset>
					<?php if (ARROWCHAT_EDITION == "enterprise" OR ARROWCHAT_EDITION == "business" OR ARROWCHAT_EDITION == "premium") { ?>
						<dl class="selectionBox">
							<dt></dt>
							<dd>
								<ul>
									<li>
										<label for="spam_protection">
											<input type="checkbox" id="spam_protection" name="spam_protection" <?php if($spam_protection == 1) echo 'checked="checked"'; ?> value="1" />
											Enable Spam Protection
										</label>
									</li>
								</ul>
								<p class="explain">
									The system will actively monitor incoming connections and deny requests for 5 minutes when spam is detected.
								</p>
							</dd>
						</dl>
					<?php } ?>
								...
								<ul>
									<li>
										<label for="enable_jquery">
											<input type="checkbox" id="enable_jquery" name="enable_jquery" <?php if($enable_jquery == 1) echo 'checked="checked"'; ?> value="1" />
											Enable JQuery
										</label>
									</li>
								</ul>
								<p class="explain">
									WARNING: JQuery is required for ArrowChat to run. Only disable this if you have another copy of it already in your header.
								</p>
							</dd>
						</dl>
						<dl class="selectionBox">
							...
							<dd>
								<ul>
									<li>
										<label for="enable_jquery_ui">
											<input type="checkbox" id="enable_jquery_ui" name="enable_jquery_ui" <?php if($enable_jquery_ui == 1) echo 'checked="checked"'; ?> value="1" />
											Enable JQuery UI
										</label>
									</li>
								</ul>
								<p class="explain">
									WARNING: JQuery UI is required for ArrowChat to run. Only disable this if you have another copy of it already in your header.
								</p>
							</dd>
						</dl>
						<dl class="selectionBox">
...
?>
					...
					<fieldset>
						...
						<dl class="selectionBox">
							...
							<dd>
								<input type="text" class="selectionText" id="admin_email" name="admin_email" value="<?php if (isset($_SESSION['arrowchat_admin_email_' . $base_url])) echo $_SESSION['arrowchat_admin_email_' . $base_url]; ?>" />
								<p class="explain">
...
?>
				...
				?>
					<script type="text/javascript">
						setTimeout(function () {
						   window.location.href= 'system.php?do=maintenance2&token=<?php echo $token; ?>';
						},1000);
					</script>
				<?php
					}
...
<?php
			...
			{
?>
								<a href="system.php?do=language&activate=<?php echo $folder['name']; ?>&token=<?php echo $token; ?>" class="secondaryContent">Activate</a>
<?php
			}
?>
								<h4>
